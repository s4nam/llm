...
export default function LoginForm({ mode }: { mode: "member" | "admin" }) {
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-surface px-4 py-12">
      ...
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        <h1 className="text-2xl font-bold text-slate-900">
          {mode === "admin" ? "Masuk Admin" : "Selamat Datang Kembali"}
        </h1>
        <p className="mt-1 text-sm text-slate-500">
          {mode === "admin"
            ? "Masuk sebagai admin untuk mengelola aplikasi."
        ...
        <form action={action} className="mt-6 flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center gap-2 text-slate-600">
              <input type="checkbox" name="remember" suppressHydrationWarning className="rounded" />
              Ingat saya
            </label>
