...
export default function AdminHeader() {
  return (
    <header className="border-b border-slate-200 bg-slate-900 text-white">
      ...
      <nav className="mx-auto flex max-w-6xl items-center gap-4 px-4 pb-3 text-sm sm:hidden">
        <Link href="/admin/materi" className="text-sky-300">
          Materi
        </Link>
        <Link href="/admin/pengaturan-ai" className="text-sky-300">
          Pengaturan AI
        </Link>
